...
os.system('espeak -a 300 " Welcome,   to,  SAFU,  King,  Tools"')
time.sleep(1)

os.system('espeak -a 300 " Join,   My,  TELEGRAM,  Safu,  CRACKER"')
...
def crack_file():
	...
	print('\033[1;97m   [ Put File Example:  /sdcard/safu.txt  Etc...]')
...
def passwrd():
	...
	print("\033[1;92m  [~] Welcome To Tool SAFU DADU WORLD")
	TARAKj(f'\033[0;97m===============================================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SAFU-DADU] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print('\x1b[1;91m==============================================================')
				os.system('espeak -a 300 " SAFU,  Ok,  id"')
				open(' /sdcard/safu.txt','a').write(idf+'|'+pw+'\n')
